...
const Index = () => {
  ...
  if (loading) {
    return <div className="min-h-screen bg-gradient-to-b from-sky-600 via-sky-500 to-green-600 flex items-center justify-center">
        <div className="text-white text-2xl">Loading...</div>
      </div>;
  }
  return <div className="min-h-screen bg-gradient-to-b from-sky-600 via-sky-500 to-green-600 p-4 flex items-center justify-center overflow-hidden relative">
      {/* Floating clouds */}
        ...
        <div className="bg-card rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
          ...
          <div className="bg-gradient-to-r from-primary via-green-600 to-accent p-6 text-primary-foreground text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {user && <p className="text-sm mt-2 opacity-90">
          ...
          <div className="p-6">
            ...
            <div className="mb-6 bg-card/50 backdrop-blur rounded-2xl p-6 border border-primary/20">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-32 h-32 flex-shrink-0">
                  <video src={terraAvatar} autoPlay loop muted playsInline className="w-full h-full object-cover rounded-lg" />
                </div>
            ...
            {/* NASA Data Info */}
            <div className="bg-gradient-to-r from-blue-50 via-green-50 to-blue-50 rounded-2xl p-6 border-2 border-blue-200 shadow-lg mb-6 py-[12px] px-[12px]">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-xs text-gray-600 text-left">Vegetation health & NDVI measurements</p>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <button onMouseEnter={() => setHoveredMode('simulation')} onMouseLeave={() => setHoveredMode(null)} onClick={() => handleModeSelect('simulation')} className="group relative bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white p-6 rounded-2xl shadow-xl transition-all transform hover:scale-105 hover:shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  {hoveredMode === 'simulation' && <div className="animate-fade-in">
              ...
              <button onMouseEnter={() => setHoveredMode('monitoring')} onMouseLeave={() => setHoveredMode(null)} onClick={() => handleModeSelect('monitoring')} className="group relative bg-gradient-to-br from-primary to-green-600 hover:from-green-600 hover:to-green-700 text-white p-6 rounded-2xl shadow-xl transition-all transform hover:scale-105 hover:shadow-2xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
                <div className="relative z-10">
                  <div className="flex justify-center mb-3">
                    <div className="bg-white/20 p-3 rounded-full">
                  ...
                  {hoveredMode === 'monitoring' && <div className="animate-fade-in">
            ...
            <div className="mb-6">
              <Button onClick={() => navigate('/real-monitoring')} variant="outline" className="w-full border-2 border-green-500 hover:bg-green-50 text-green-700 font-semibold">
